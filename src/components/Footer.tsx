          ...
          <div>
            ...
            <div className='flex gap-2 flex-wrap items-center'>
              <div className='w-10 h-10 block'>
                <a target="_blank" href="https://www.facebook.com/hivictuspvtltd/" className='shadow-lg rounded-full'>
              ...
              <div className='w-10 h-10 block'>
                <a target="_blank" href="https://www.linkedin.com/company/hivictus/" className='shadow-lg rounded-full'>
                  <svg className='w-full h-full' xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 48 48">
              ...
              <div className='w-10 h-10 block'>
                <a target="_blank" href=" https://www.youtube.com/@hivictuspvtltd" className='shadow-lg rounded-full'>
                  <svg className='w-full h-full' xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 48 48">
              ...
              <div className='w-10 h-10 block'>
                <a target="_blank" href="https://www.instagram.com/hivictuspvtltd/" className='shadow-lg rounded-full'>
                  <svg className='w-full h-full' xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 48 48">
              ...
              <div className="w-10 h-10 block">
                <a target="_blank" href="https://x.com/Hivictuspvtltd " className='shadow-lg rounded-full'>
                  <svg className='w-full h-full' xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 48 48">
